...
class BatuShop extends Component {
  render() {
    return (
      <View style={{flex: 1, backgroundColor: 'white'}}>
        <View
          ...
          <View
            ...
            <Text style={{fontSize: 18, fontWeight: 'bold'}}>Rp.750.000</Text>
          ...
          <View
            ...
            <Text>Penjual Odi</Text>
            <Text>Kontak - 085232181798</Text>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <View style={{marginLeft: 10}}>
              ...
              <Text style={{color: 'white'}}>Batu Gunung</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={{
